...
const Navbar = () => {
  ...
  return (
    ...
    justify-between mb-[35px] gap-6'>
      <div className='lg:flex 1 flex flex-row  w-[250px] max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[75px]'>
        <input type="text" placeholder='Search Campaigns' 
        className='flex w-full font-epilogue font-normal text-[14px] 
        placeholder:text-[$3b5264] text-white bg-transparent outline-none'/>
